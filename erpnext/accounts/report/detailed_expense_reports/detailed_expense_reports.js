...
frappe.require("assets/erpnext/js/financial_statements_custom.js", function() {
        frappe.query_reports["Detailed Expense Reports"] = $.extend({},
                erpnext.financial_statements_custom);

//console.log("filetrs"+JSON.stringify(frappe.query_reports["Detailed Expense Reports"]["filters"]));
        frappe.query_reports["Detailed Expense Reports"]["filters"].push(
